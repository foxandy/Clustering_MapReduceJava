...
public class Clustering extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		JobConf conf = new JobConf(getConf(), Clustering.class);
    ...
    public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new Clustering(), args);
		System.exit(res);
    }
}
